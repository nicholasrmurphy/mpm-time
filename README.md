# mpm-time
This project was started with the intent of digitizing a contractors process of collecting timesheets. 
The information from these forms was then used for payroll and client billing by hour. 
This software allows users to create an account and begin recording work entries to the database.  
